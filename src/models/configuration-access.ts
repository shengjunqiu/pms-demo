...
export interface AccessPolicyVersion extends ConfigurationVersion {tenantId:string;role:UserRole;dataScope:DataScope;orgIds:string[];pages:string[];actions:string[];fields:SensitiveField[];projectRelationRequired:boolean;}
