...
export interface AssessmentRound { id: string; version: number; status: '评估中' | '已确认'; opinions: Partial<Record<AssessmentDimension, DimensionOpinion>>; startedAt: string; conclusion?: string; reason?: string; confirmedAt?: string; ruleVersion?: string; score?: number; riskLevel?: string }
