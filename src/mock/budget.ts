...
export function initializePlanning(state:BusinessState) {
 const p={...structuredClone(state.projects[0]),id:PLANNING_PROJECT_ID,health:'green' as const,healthReason:'各项指标受控正常',code:'PMS-2026-PLAN-001',name:'福建园区设备运维协同平台',opportunityId:planningOpportunity.id,phase:'立项' as const,subPhase:'WBS编制' as const,status:'正常进行' as const,isUnsigned:true,isMaintenance:false,contractAmount:0,revenueAmount:1200,frozenEstimateVersionId:'EST-PLAN-001',budgetAmount:0,rollingCost:0,actualCost:0,committedCost:0,forecastRemainingCost:0,costVariance:0,costVarianceRate:0,progressRate:0,plannedStartDate:AS_OF_DATE,plannedEndDate:'2026-12-31',actualStartDate:undefined,actualEndDate:undefined,currentBaselineVersion:'未形成',memberIds:['U-001','U-005'],unsignedLimitQuota:0,commitmentBySubject:{}};
